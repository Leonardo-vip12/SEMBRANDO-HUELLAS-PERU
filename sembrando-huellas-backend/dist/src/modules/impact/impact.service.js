...
let ImpactService = ImpactService_1 = class ImpactService extends base_crud_service_1.BaseCrudService {
    constructor(prisma) {
        super(prisma);
        this.prisma = prisma;
        this.logger = new common_1.Logger(ImpactService_1.name);
        this.modelName = 'Métrica de Impacto';
    }
    get prismaDelegate() {
...
exports.ImpactService = ImpactService = ImpactService_1 = __decorate([
