...
var SiaMapsService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.SiaMapsService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../../prisma/prisma.service");
let SiaMapsService = SiaMapsService_1 = class SiaMapsService {
    constructor(prisma) {
        this.prisma = prisma;
        this.logger = new common_1.Logger(SiaMapsService_1.name);
    }
    async getLayers() {
        const [projects, campaigns, institutions, reforestations, protectedAreas, observations, species, events] = await Promise.all([
    ...
    async getLayerData(layer, filters) {
        switch (layer) {
            case 'projects': {
            ...
            default:
                throw new common_1.BadRequestException(`Capa "${layer}" no encontrada`);
        }
    }
...
exports.SiaMapsService = SiaMapsService;
exports.SiaMapsService = SiaMapsService = SiaMapsService_1 = __decorate([
