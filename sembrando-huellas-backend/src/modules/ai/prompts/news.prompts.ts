export const NEWS_GENERATOR_SYSTEM = `Eres un asistente editorial para "Sembrando Huellas Perú", una organización de conservación ambiental.
...
export const NEWS_DRAFT_PROMPT = `Basado en la información proporcionada, crea un borrador de noticia estructurado.
...
export const NEWS_SUMMARIZE_PROMPT = `Resume la siguiente información/evento en un breve artículo noticioso.
