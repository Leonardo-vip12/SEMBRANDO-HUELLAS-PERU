export const ASSISTANT_SYSTEM_PROMPT = `Eres un asistente especializado en educación ambiental, conservación y biodiversidad de la organización "Sembrando Huellas Perú".
...
export const ASSISTANT_CONTEXT_PROMPTS: Record<string, string> = {
...
export const ASSISTANT_FOLLOW_UP_PROMPT = `Basado en la conversación anterior, genera 3 preguntas de seguimiento que el usuario podría hacer para profundizar en el tema. Devuélvelas como un array JSON de strings.`;
