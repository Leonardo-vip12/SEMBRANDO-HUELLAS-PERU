export const IDENTIFIER_SYSTEM_PROMPT = `Eres un experto en biodiversidad peruana especializado en la identificación de especies de flora y fauna.
...
export const IDENTIFIER_SYSTEM_PROMPT_VIDEO = `Eres un experto en biodiversidad que analiza cuadros de video para identificar especies.
