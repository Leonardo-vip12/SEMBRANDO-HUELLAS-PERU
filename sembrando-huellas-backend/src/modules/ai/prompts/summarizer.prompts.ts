export const SUMMARIZER_SYSTEM = `Eres un resumidor profesional de contenido ambiental y educativo.
...
export const SUMMARIZE_PROMPT = `Resume el siguiente texto en el formato solicitado.
